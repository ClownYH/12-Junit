...
public class AdditionalAnnotationTests {
    ...
    * */
    ...
    public void testTimeout() throws InterruptedException{
        Thread.sleep(900); // 1000을 넘는 순간 에러가 발생한다.
    }
    ...
    * */
    @Test
    @Tag("development") // 태그는 특정 대상을 지시하거나 제외할 수 있도록 정한 것이다.(edit configuration에서 junit을 확인할 것)
    ...
    /*
    * 여러 개 실행하는 경우 | 또는 &를 첨부한다.
    * */
    @Test
    @Tags(value = {@Tag("development"), @Tag("performance")}) // 다중으로 선택도 가능하다.
